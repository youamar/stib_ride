...
import g54915.model.jdbc.StopDutchDao;
...
public class StopDutchRepository implements Repository<Pair<Integer, Integer>, StopDto> {

    private final StopDutchDao dao;

    public StopDutchRepository() throws RepositoryException {
        dao = StopDutchDao.getInstance();
    }
